    ...
    <section class="fixed top-0 left-0 w-full z-50 bg-[#5a4a3a]/80 backdrop-blur-md shadow-lg border-b border-white/10">
      <header class="flex mx-auto justify-between items-center max-w-[1300px] py-2 px-4 md:px-8">
        <div class="flex items-center gap-3">
            ...
            <img src="../public/assets/tobacco.png" alt="Tobacco Logo" class="w-10 md:w-16 h-10 md:h-16">
          
          <span class="text-white font-bold text-lg">TOBAC.CO</span>
        </div>
        <nav class="hidden sm:inline-block">
          <ul class="flex gap-2 lg:gap-6">
            <li><a href="#heroSection" class="uppercase font-bold text-sm text-white hover:text-[#77B254] rounded-md px-3 py-2 transition-colors duration-300">HOME</a></li>
            <li><a href="#" class="uppercase font-bold text-sm text-white hover:text-[#77B254] rounded-md px-3 py-2 transition-colors duration-300">IDENTIFY</a></li>
            <li><a href="#" class="uppercase font-bold text-sm text-white hover:text-[#77B254] rounded-md px-3 py-2 transition-colors duration-300">CULTIVATION</a></li>
            <li><a href="#" class="uppercase font-bold text-sm text-white hover:text-[#77B254] rounded-md px-3 py-2 transition-colors duration-300">CONTACT</a></li>
          </ul>
        </nav>
        <div class="hidden sm:flex items-center gap-4">
          <button class="uppercase font-bold text-xs text-white border-2 border-white rounded-[40px] py-2 px-6 hover:bg-white hover:text-[#77B254] transition-all duration-300 transform hover:scale-105">SCAN NOW</button>
        </div>
